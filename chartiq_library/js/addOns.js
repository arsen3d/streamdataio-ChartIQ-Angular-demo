...
(function (definition) {
		...
		this.stx.append("initializeDisplay", function(){
			...
			if(styles.session){
				...
				for(var panel in this.panels){
					...
					if(this.panels[panel].hidden) continue;
	 ...
	 * @since 3.0.0
	 * @example
	 * 	CIQ.InactivityTimer({stx:stxx, minutes:30, interval:15});  //30 minutes of inactivity will put chart into sleep mode, updating every 15 seconds
	 *
	 */
	 ...
	 * @example
	 * 	CIQ.Animation(stxx, {tension:0.3});  //Default animation with splining tension of 0.3
	 *
	 */
